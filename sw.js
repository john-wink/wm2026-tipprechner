...
const VERSION = 'v2026.05.24.1634';
const CACHE = 'wm2026-' + VERSION;

const CORE = [
  '/',
  '/de/', '/en/', '/fr/', '/es/',
  '/assets/app.js?v=v2026.05.24.1634',
  '/assets/i18n.js?v=v2026.05.24.1634',
  '/assets/styles.css?v=v2026.05.24.1634',
  '/assets/tailwind.css?v=v2026.05.24.1634',
  '/favicon.svg',
  '/icon-192.svg',
  '/icon-512.svg',
  '/og-image.svg',

...
const VERSION = 'v2026.06.28.1436';
const CACHE = 'wm2026-' + VERSION;

const CORE = [
  '/',
  '/de/', '/en/', '/fr/', '/es/',
  '/assets/app.min.js?v=v2026.06.28.1436',
  '/assets/i18n.min.js?v=v2026.06.28.1436',
  '/assets/styles.css?v=v2026.06.28.1436',
  '/assets/tailwind.css?v=v2026.06.28.1436',
  '/favicon.svg',
  '/icon-192.svg',
  '/icon-512.svg',
  '/og-image.svg',
